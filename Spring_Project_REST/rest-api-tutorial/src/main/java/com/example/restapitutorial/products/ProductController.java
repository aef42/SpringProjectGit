...
public class ProductController {
    ...
    public Product readProduct (@PathVariable Long productId) {
        ...
        throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Product with this id was not found");
    }
    ...
    public void deleteProduct(@PathVariable Long productId) {
        ...
        throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Cannot delete, what cannot be found, Kiddo!");
    }
